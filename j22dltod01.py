...
class jlrn:
    ...
    jntms = [[0,15], [15,75], [75,1440], [1440,100000]]
...
def jrun():
    ...
    print("Saving", './cmodels/j22dltod01_%s_%s.h5' % (jlrn.pat, jlrn.epoch))
    jlrn.model.save('./cmodels/j22dltod01_%s_%s.h5' % (jlrn.pat, jlrn.epoch))
