...
def jget_file_list():
    ...
    # dirdict = {'23_002':'../data23002/', '24_005':'../data24005/', '25_003': '../data25003/'}
    # #dirdict = {'23_002':'../data23_002val/', '24_005':'../data24005/', '25_003': '../data25003/'}
    # if jlrn.pat not in dirdict.keys():
    #     print("Error with finding patient directory")
    #     killnow()
    # pdir = os.listdir(dirdict[jlrn.pat])
    # for fn in pdir:
    #     #fn 2300220101120011410520.mat
    #     if '.mat' not in fn:
    #         continue
    #     tm = int(fn[17:-4])
    #     jpos = -1
    ...
    #                 break
    #     if jpos >= 0:
    #         dfn = dirdict[jlrn.pat]+fn
    #         jlrn.fdict[pos]['all'].append(dfn)
    #         jlrn.fdict[pos]['tm'][dfn] = tm
...
def jget_data():
    ...
    for fnd in jlrn.cflist[:jlrn.jnumb]:
        ...
        for jelec in jlrn.jeleclist:
            ...
            #print('fan', fan['Data'].shape)
            #print('jdata', jdata.shape)
            #print('cjoff', cjoff)
...
def jrun():
    ...
    jsep = 0
    if sys.argv[2] != '0':
        jlrn.model = tf.keras.models.load_model('./models/j22lstm01_%s_%s.h5' % (sys.argv[1], sys.argv[2]))
    ...
    for jepoch in range(jsep,101):
        ...
        print(jepoch, len(jlrn.cflist), tot[1]/tot[0], tot[2]/tot[0])
        sys.stdout.flush()
        print("Saving", './models/j22lstm01_%s_%d.h5' % (sys.argv[1], jepoch))
        jlrn.model.save('./models/j22lstm01_%s_%d.h5' % (sys.argv[1], jepoch))
    return
